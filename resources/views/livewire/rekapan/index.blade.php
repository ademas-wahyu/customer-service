    ...
    <div class="py-12">
        <div class="sm:px-6 lg:px-8 grid grid-cols-3 max-w-7xl mx-auto gap-4">
            <div class="bg-white p-4 rounded-xl shadow-lg flex justify-between items-center">
                ...
                <div class="relative flex justify-center items-center w-16 h-16 bg-[#E6A900] bg-opacity-25 p-2 rounded-full">
            ...
            <div class="bg-white p-4 rounded-xl shadow-lg flex justify-between items-center">
                ...
                <div class="relative flex justify-center items-center w-16 h-16 bg-[#000080] bg-opacity-25 p-2 rounded-full">
                    <svg viewBox="0 0 46 43" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10">
            ...
            <div class="bg-white p-4 rounded-xl shadow-lg flex justify-between items-center">
                ...
                <div class="relative flex justify-center items-center w-16 h-16 bg-[#00C707] bg-opacity-25 p-2 rounded-full">
                    <svg viewBox="0 0 46 43" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10">
